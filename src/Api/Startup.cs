...
namespace Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string dbUserPassword= System.Environment.GetEnvironmentVariable("DBPASSWORD") ?? "123";
            string dbName= System.Environment.GetEnvironmentVariable("DBNAME") ?? "accountgo";
